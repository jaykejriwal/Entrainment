...
sessList= sorted(glob.glob('/home/jay_kejriwal/Fisher/Processed/Embeddings/Text_syntactic/*.txt',recursive=True))
...
hf = h5py.File(r'/home/jay_kejriwal/Fisher/Processed/h5/syntactic/train_nonorm.h5', 'w')
