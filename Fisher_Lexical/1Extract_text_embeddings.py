...
def process_syn_text(text):         #Function to remove punctuation and extrat lemma and pos
    words = text.lower()
    doc = nlp(words)
    l=[f'{word.lemma}' for sent in doc.sentences for word in sent.words]
...
output_path = '/home/jay_kejriwal/Fisher/Processed/Embeddings/Text_lexical'
...
for file_name in list_of_files:
    ...
    #Each consecutive utterance is of size 2048 i.e 1024 for each utterance
    chunks = [out[x:x+2048] for x in range(0, len(out)-1024, 1024)]
